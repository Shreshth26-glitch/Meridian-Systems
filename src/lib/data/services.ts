...
export const services: RawService[] = [
  {
    ...
    overview:
      "Most enterprises run finance, operations, and HR on disconnected systems that don't talk to each other. We design and deploy a single ERP core built around your actual workflows, not a generic template — covering requirements mapping, module configuration, and legacy data migration.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We build production websites engineered for performance, SEO, and long-term maintainability — not assembled from page builders. Every site is architected around your content model and traffic patterns from day one.",
    capabilities: [
      "Custom design-to-code implementation",
      "CMS integration",
  ...
  },
  {
    ...
    overview:
      "From internal tools to customer-facing platforms, we build web applications that handle real operational complexity — authentication, permissions, data pipelines — not just static pages.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We build native Android applications for enterprises that need performance and platform-specific polish, integrated tightly with your existing backend systems.",
    capabilities: [
      "Native Kotlin development",
      "Offline-first architecture",
      "Play Store deployment and compliance",
      "Backend integration",
    ],
  ...
  },
  {
    ...
    overview:
      "We build native iOS applications with the performance and design polish enterprise users expect, from initial App Store submission through long-term version support.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "For teams that need to ship to both platforms without doubling engineering cost, we build cross-platform applications that don't compromise on performance or platform-native feel.",
    capabilities: [
      "Shared codebase architecture",
      "Platform-specific UI adaptation",
      "CI/CD for dual-platform releases",
      "Backend integration",
    ],
    timeline: "10–18 weeks",
  ...
  },
  {
    ...
    overview:
      "We build and execute social strategy grounded in measurable outcomes — audience growth, engagement, and pipeline contribution — not vanity metrics.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We combine technical site audits, content strategy, and structured data implementation to improve organic visibility in ways that compound over time rather than chase short-term ranking tricks.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We design database architectures that hold up under real production load — proper indexing, replication strategy, and disaster recovery — plus ongoing management for enterprises that need reliable data operations.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We design and manage cloud infrastructure built for reliability — automated deployments, monitoring, and incident response — so your systems stay up under real-world load, not just in testing.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We design and build APIs that make your systems talk to each other correctly — proper versioning, authentication, and documentation — plus integration work connecting third-party platforms into your stack.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We identify where manual processes are costing your team time and replace them with AI-driven automation — document processing, intelligent routing, and workflow orchestration built around your actual operations.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We design digital products starting from user research and business goals, not aesthetics alone — producing interfaces that are both distinctive and genuinely usable at enterprise scale.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We assess and harden systems against real threats — vulnerability audits, compliance alignment, and security built into the development process itself, not bolted on afterward.",
    capabilities: [
  ...
  },
  {
    ...
    overview:
      "We work with leadership teams to map technology strategy against real business goals — system modernization roadmaps, vendor evaluation, and organizational readiness for large-scale digital change.",
    capabilities: [
