...
const processSteps = [
  {
    step: "01",
    name: "Discover",
    desc: "Map the system constraint and establish clear service level objectives.",
  },
  {
    step: "02",
    name: "Research",
    desc: "Deploy telemetry and conduct empirical dependencies assessments.",
  },
  {
    step: "03",
    name: "Architecture",
    desc: "Design target state blueprint and risk-managed migration sequences.",
  },
  {
    step: "04",
    name: "Development",
    desc: "Embed engineering squads to build core codebase integration paths.",
  },
  {
    step: "05",
    name: "Testing",
    desc: "Execute automated contract, load, and performance verification.",
  },
  {
    step: "06",
    name: "Deployment",
    desc: "Execute zero-downtime strangler cuts with phased canary rollouts.",
  },
  {
    step: "07",
    name: "Growth",
    desc: "Provide follow-the-sun managed platform operations and optimization.",
  },
];
...
const industries = [
  {
    name: "Healthcare",
    desc: "Secure clinical data platform routing and EMR system consolidation.",
  },
...
const testimonials = [
  {
    quote:
      "Meridian did not arrive with slide decks. They embedded five senior engineers in our clearing team, mapped our database locks, and moved settlement onto Kafka. Our latency targets were met four weeks ahead of schedule.",
  ...
  {
    quote:
      "Most agencies stack their squads with juniors and require constant oversight. Meridian's principal engineers integrated directly, established clear service level agreements, and automated 2.4 million manual loops cleanly.",
    author: "Marcus Vance",
  ...
  {
    quote:
      "Consolidating clinical histories across 40 disparate hospital EMR estates seemed insurmountable. Meridian mapped data contracts, built real-time streams, and now we sync patient data instantly under security audits.",
...
function Index() {
  ...
  const currentCoords = (hoveredIndustry !== null && glowCoords[hoveredIndustry]) || {
    cx1: "50%",
    cy1: "50%",
    cx2: "50%",
    cy2: "50%",
  ...
  return (
    <>
              ...
              return (
                ...
                >
                  ...
                  <div className="md:mt-5">
                    ...
                    <p
                      className={`mt-2 text-[13.5px] transition-opacity duration-300 md:line-clamp-3 ${isActive ? "opacity-100" : "opacity-60 md:opacity-0 group-hover:opacity-60"}`}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-border bg-surface/30">
                ...
                <th className="p-5 font-semibold text-[14px] w-[40%] text-secondary-foreground">
            ...
            <tbody>
              {comparisons.map((c, i) => (
                ...
                >
                  ...
                  <td
                    className="p-5 text-[14px] align-top"
                    style={{ color: "var(--text-secondary)" }}
                  >
                    {c.traditional}
                  </td>
      ...
      <section className="relative overflow-hidden py-24 border-t border-border scroll-reveal">
        ...
        <svg
          className="absolute inset-0 w-full h-full -z-10 transition-all duration-[600ms] pointer-events-none"
          aria-hidden="true"
        >
          <defs>
              ...
              <Reveal key={study.slug} delay={i * 80} className="flex h-full w-full">
                ...
                >
                  ...
                  <div className="border-t border-border p-5 flex flex-col justify-between flex-1">
                    <div>
                      <span
                        className="text-[11.5px] font-semibold uppercase tracking-[1px]"
      ...
      <section className="shell py-24 border-t border-border scroll-reveal">
        ...
        <Reveal className="mt-14 max-w-4xl mx-auto relative rounded-xl border border-border p-8 md:p-12 bg-surface/20 w-full block">
          <div className="min-h-[160px]">
            <p
              ...
              className="text-[20px] md:text-[22px] font-display italic leading-relaxed text-foreground quote-fade"
            >
        ...
        <div className="mt-12 border-t border-border pt-10">
          <p
            className="text-[11.5px] font-semibold text-center uppercase tracking-[1.5px]"
            style={{ color: "var(--text-muted)" }}
          >
          ...
          <div className="mt-6 flex flex-wrap justify-center items-center gap-x-12 gap-y-6 opacity-60">
            {[
              ...
              <span
                key={l}
                className="font-display font-bold tracking-tight text-[15px] whitespace-nowrap"
              >
                {l}
              </span>
            ))}
        ...
        <div className="grid gap-10 lg:grid-cols-[45fr_55fr] items-stretch">
          ...
          <div className="relative overflow-hidden rounded-xl border border-border bg-black min-h-[460px] flex flex-col justify-end p-8 md:p-12 shadow-inner">
            <div
              ...
              style={{ backgroundImage: "url('/vortex_abstract_bg.png')" }}
            />
            ...
            <div className="relative z-10 max-w-md text-left">
              ...
              <p className="mt-4 text-[14.5px] leading-relaxed text-zinc-300">
                Find out more about how we can help your organization navigate its next. Let us know
                your areas of interest so that we can serve you better.
              </p>
            </div>
          </div>
            ...
            {formSuccess ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="mt-2 text-[14px]" style={{ color: "var(--text-secondary)" }}>
                  Thank you for your interest. A principal engineer from our team will contact you
                  shortly.
                </p>
                <button
                  type="button"
                  onClick={() => setFormSuccess(false)}
                  className="btn-base btn-secondary mt-6 text-[13px] py-1.5 px-4 cursor-pointer"
                >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label
                      ...
                      className="text-[12px] font-medium text-secondary-foreground block mb-1"
                    >
                      First Name *
                    </label>
                    <input
                      ...
                      onChange={(e) =>
                        setRequestForm({ ...requestForm, firstName: e.target.value })
                      }
                  ...
                  <div className="sm:col-span-2 flex items-start gap-3 mt-2">
                    <button
                      ...
                      onClick={() =>
                        setRequestForm({
                          ...requestForm,
                          marketingOptIn: !requestForm.marketingOptIn,
                        })
                      }
                    ...
                    >
                      <span
                        className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${requestForm.marketingOptIn ? "translate-x-4" : "translate-x-0"}`}
                      />
                    </button>
                  ...
                  <div className="sm:col-span-2 flex items-start gap-3">
                    ...
                    >
                      <span
                        className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${requestForm.agreeTerms ? "translate-x-4" : "translate-x-0"}`}
                      />
                    </button>
                    <span className="text-[13px] text-secondary-foreground leading-normal">
                      I agree to the{" "}
